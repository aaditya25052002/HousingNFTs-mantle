...
import { buyNFT, setStatus } from "../Blockchain.Services";
...
const ShowNFT = () => {
  ...
  const handleNFTPurchase = async () => {
    ...
    try {
      ...
      sendmail();
      setAlert(
        "Transfer completed,you can also check your NFT on your specific email",
        "green"
      );
  ...
  // const [uday, setuday] = useState(true);
  // const booli = async () => {
  //   const dnft = await sellStatus(nft);
  //   console.log(dnft);
  //   setuday(dnft);
  // };
  // booli();
      ...
      <div className="bg-[#151c25] shadow-xl shadow-[#e32970] rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col justify-start rounded-xl mt-5">
            ...
            <a href="https://yourhousepreview.web.app">
              {" "}
              <RemoveRedEyeIcon />
            </a>
            ...
            <div className="flex justify-between items-center mt-3 text-white">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm font-semibold">{nft?.cost} MATIC </p>
              </div>
            </div>
          </div>
          <div className="flex justify-between items-center space-x-2">
            {connectedAccount != nft?.owner ? (
              <div className="flex flex-row justify-between items-center bg-transparent-800 rounded-full mt-5">
                <input
                  className="
